...
// Database - 使用统一的模型索引
const { sequelize, User, Guest, GameRecord, Card, PointsTransaction, UserActionLog, ErrorLog } = require('./models');
...
(async () => {
    try {
        ...
        console.log('✅ Models synced (User, Guest, GameRecord, Card, PointsTransaction, UserActionLog, ErrorLog).');
    } catch (error) {
